...
import YtServicesDashboardSidebarLinks from "@/components/YtServicesDashboard/YtServicesDashboardSidebarLinks";
import React from "react";

export default function YtServicesDashboardSidebar() {
  return (
    <aside className="w-full h-full flex flex-col justify-between p-8">
      <div className="w-full h-full flex flex-col gap-20">
        <LogoIcon />

        <YtServicesDashboardSidebarLinks />
      </div>
