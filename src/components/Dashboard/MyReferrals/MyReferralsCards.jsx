import useMyReferralsCardDataQuery from "@/hooks/Dashboard/useMyReferralsCardDataQuery";
import React from "react";


export default function MyReferralsCards() {

    const info = useMyReferralsCardDataQuery();
  return (
