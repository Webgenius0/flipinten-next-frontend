  ...
  return (
    <section className="py-32">
      ...
      <div className="gradient container">
        ...
        <div
          className="relative mx-auto mt-20 flex h-112 max-w-4xl items-center justify-center gap-2">
          {[
...
const BarChart = ({
  ...
  return (
    <div className="group relative h-full w-full">
      <div
        className="candy-bg relative h-full w-full overflow-hidden rounded-[40px]">
        <motion.div
          ...
          <div
            className="relative flex h-15 w-full items-center justify-center gap-2 rounded-full bg-muted/20 tracking-tighter">
