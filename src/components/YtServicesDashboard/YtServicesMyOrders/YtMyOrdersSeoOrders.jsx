...
import useYtMyOrdersSeoOrdersTableDataQuery from "@/hooks/YtSrvicesDashboardHooks/useYtMyOrdersSeoOrdersTableDataQuery";
import {
  flexRender,
  getCoreRowModel,
  useReactTable,
...
export default function YtMyOrdersSeoOrders() {
  const orders = useYtMyOrdersSeoOrdersTableDataQuery();
  ...
  return (
    <div className="bg-white w-full p-8 rounded-2xl">
      <div className="flex items-center justify-between mb-4">
        <p className="text-2xl font-bold mb-4">SEO Orders</p>
      </div>
