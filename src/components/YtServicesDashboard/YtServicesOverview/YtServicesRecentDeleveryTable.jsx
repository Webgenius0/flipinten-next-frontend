...
export default function YtServicesRecentDeleveryTable() {
  const deliveries = useYtOverviewRecentDeliveryTableDataQuery();
  ...
  return (
    <div className="bg-white w-full p-8 rounded-2xl">
      <div className="flex items-center justify-between mb-4">
        <p className="text-2xl font-bold mb-4">Recent Deliveries</p>
        <button
          type="button"
          className="flex items-center gap-2 text-lg text-neutral500 cursor-pointer bg-card py-2 px-4 rounded-full"
        >
          <p className="w-6 h-6">
            <EyeSvg />
          </p>
