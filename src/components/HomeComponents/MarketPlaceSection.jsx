...
const MarketPlaceSection = () => {
  return (
    <CommonSection className={"relative"}>
      <SectionHeading
        title={"Marketplace"}
        subtitle={
          "Connect creators with investors and advertisers in our thriving marketplace"
        }
        className={"text-left"}
      />
        ...
        <div className="space-y-9">
          <div className="p-6 flex items-start gap-6">
            ...
            <div>
              ...
              <p className="font-medium text-lg text-neutral90 mt-2 mb-6">
                List your channel and earn from endorsements
              </p>
              <Button className={"w-50"}>List Channel</Button>
            </div>
          </div>
          ...
          <div className="p-6 flex items-start gap-6">
            ...
            <div>
              ...
              <p className="font-medium text-lg text-neutral90 mt-2 mb-6">
                Book campaigns with top creators
              </p>
              <Button className={"w-50"}>Book campaigns</Button>
            </div>
          </div>
        </div>
